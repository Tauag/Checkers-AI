...
public class ThirtyFiveRepBoardRevised implements CheckersGameState{
	private String _playerTurn;
	private String _winner;
	private ThirtyFiveRepCheckerPiece[] _set;
	
	public ThirtyFiveRepBoardRevised(){
		_playerTurn = "Black";
		_set = new ThirtyFiveRepCheckerPiece[35];
		initBoard();
	}
	
	public ThirtyFiveRepBoardRevised(String turn, ThirtyFiveRepCheckerPiece[] set){
		_playerTurn = turn;
		_winner = null;
		_set = set;
	}
	...
	public CheckersGameState result(Move x) {
		...
		return new ThirtyFiveRepBoardRevised(next, newset);
	}
